#For this project we are using MySQL, please follow a youtube tutorial(e.g. Install MySQL for mac or windows). #Once you have created root users and password EXECUTE script.sql on your SQL script.
